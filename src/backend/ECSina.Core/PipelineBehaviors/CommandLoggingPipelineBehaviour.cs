...
public sealed class CommandLoggingPipelineBehaviour<TRequest, TResponse>
    ...
    where TRequest : CommandBase<TResponse>
{
    ...
    public CommandLoggingPipelineBehaviour(
        ILogger<CommandLoggingPipelineBehaviour<TRequest, TResponse>> logger,
